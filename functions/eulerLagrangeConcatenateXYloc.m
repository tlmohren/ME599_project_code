function [ strainSet ] = eulerLagrangeConcatenateXYloc(ph,th,sensor_vec,error,par)
...
%     else
        ...
        strain_0 = eulerLagrangeXYloc(0,ph,th ,sensor_vec,error,par);
        strain_10 = eulerLagrangeXYloc(10,ph,th ,sensor_vec,error,par);
